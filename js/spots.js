// ========================================
// SPOTS DATA HANDLING WITH AZURE API
// ========================================

/**
 * Get all tourist spots from Azure API
 */
...
/**
 * Get a single spot by ID from Azure API
 */
...
async function addSpot(spotData) {
    ...
    try {
        ...
        // If image is base64, upload to Blob Storage first
    ...
    return [
        {
            ...
            fullDescription: "Sigiriya, also known as the Lion's Rock, is a magnificent ancient rock fortress.",
        ...
        },
        {
            ...
            rating: 4.7,
            shortDescription: "Stunning mountain viewpoint with lush green landscapes.",
            fullDescription: "Ella Rock is a popular hiking destination offering spectacular views.",
